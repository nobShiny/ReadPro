...
public class LoginActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/**
		 * // 设置获取验证码事件 btnGetCaptcha.setOnClickListener(new OnClickListener() {
		...
		public void handleMessage(Message message) {
			...
			case GET_IMAGE_MESSAGE:
				...
				if (message.arg1 > 0) {
					...
					// new
					// AlertDialog.Builder(LoginActivity.this).setTitle("提示")
			...
			case LOGIN_MESSAGE:
				...
				if (message.arg1 > 0) {
					...
					new AlertDialog.Builder(LoginActivity.this)
							.setTitle("提示")
							.setMessage("登录验证失败，请检查用户名密码是否正确！如果有验证码，请输入验证码重试！")
